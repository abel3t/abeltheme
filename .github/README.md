...
```lua
require("abeltheme").setup({
  palette = "abeldark", -- String of the default palette to use when calling `:colorscheme abeltheme`

  termguicolors = true, -- Bool value, toggles if termguicolors are set by AbelTheme.

  terminal_color = true, -- Bool value, toggles if terminal_colors are set by AbelTheme.
  ...
  palettes = {
    ...
    abeldark = {          -- Extend or modify abeldarks palette colors
      red = "#800010",      -- Overrides abeldarks red color
