C = {}
local util = require "abeltheme.lib.util"
...
function M.load(theme)
  ...
  local highlights = {}
  highlights = util.get_hl_modules(highlights, "abeltheme.groups", {
    "base",
    "syntax",
    "lsp",
    "astronvim",
  ...
  highlights = util.get_hl_modules(highlights, "abeltheme.groups.plugins", M.config.plugins)
...
function M.setup(opts)
  M.config = require("abeltheme.lib.config").user_config(opts)
